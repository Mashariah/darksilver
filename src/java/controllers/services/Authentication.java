...
public class Authentication {
    ...
    private final static Logger lg = Logger.getLogger(Authentication.class.getName());
    ...
    public static boolean validateUser(String user, String password) {
        ...
        EntityManager entityManager = Connection.getConnector();
        boolean valid = false;
        lg.info("User in validateUser is: " + user);
        /**
        ...
        System.out.println("Type for obj: " + u.getClass().toString());
